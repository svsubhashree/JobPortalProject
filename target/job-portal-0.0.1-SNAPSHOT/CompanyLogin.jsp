...
body {
	background-image:
		url("https://www.snapphotography.co.nz/wp-content/uploads/Commercial-architectural-photography-christchurch-02-1024x594.jpg");
	color: #000;
	font: 14px Arial;
	margin: 0 auto;
	padding: 0;
...
<body>
	<div class="container">
		<section id="content">
			<form method="get" action="./validateCompany" modelAttribute="login">
				<h1>Company Login</h1>
				<div>
					<input type="text" name="email" placeholder="Email-Id" required
						id="username" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" />
				</div>
				<div>
				...
				<div>
					<input type="submit" value="Submit" /> <a href="#"><strong>Lost
							your password?</strong></a> <a href="registerCompany.jsp"><strong>Register</strong></a>
				</div>
			</form>
		</section>
	</div>
