		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="ViewAllJobs.jsp?username=${username}">Jobs</a></li>
		...
		<div class="row content">
			<div class="col-sm-2 sidenav">
				...
				<p>
					<br>
				<form action="" method="">
					<a class="two" href="">Update Profile</a>
				</form>
				</p>
				<p>
				<form action="Jobs" method="post">
					<a class="two" href="ViewAllJobs.jsp?username=${username}">Job
						Search</a>
				</form>
				</p>
				<p>
					<a class="two" href="ViewAppliedJobs.jsp?username=${username}">Job
			...
			<div class="col-sm-8 text-left">
				...
				<hr>
				<h3>Top 9 New Technology Trends for 2022 and 1 Solution to
					Succeed in Them</h3>
				<p>
				<ol>
				...
				<a
					href="https://www.simplilearn.com/top-technology-trends-and-jobs-article">Click
					here to view the article on these new technologies and career
					opportunities...</a>
			</div>
			<div class="col-sm-2 sidenav">
