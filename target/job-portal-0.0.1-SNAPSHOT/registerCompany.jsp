...
<div id="container">
	<form action="./registerCompanyUser" method="post" modelAttribute="company">
			<input type="email" placeholder="E-mail Id" name="email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required><br />
			...
			<input type="password" placeholder="Password" name=password pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required><br />
